...
const ManageLibraryPage = () => {
  ...
  const [changeQuantityOfBooksClick, setChangeQuantityOfBooksClick] =
    useState(false);
  // to cause rerender when tab is switched
  ...
  // need to be admin to be get to admin page
    ...
    <div className='container'>
      <div className='mt-5'>
        ...
        <div className='tab-content' id='nav-tabContent'>
          ...
          >
            {changeQuantityOfBooksClick ? <h1>Change Quanity</h1> : <></>}
          </div>
          <div
            className='tab-pane fade'
            id='nav-messages'
          ...
          >
            {messagesClick ? <h1>Admin Messages</h1> : <></>}
          </div>
        </div>
      </div>
    </div>
